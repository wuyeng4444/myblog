...
export default function Home() {
  ...
  return <><Navbar /><main className="personal-home">
    ...
    <section id="work" className="personal-section" aria-labelledby="work-title">
      <div className="personal-section-heading"><div><p className="personal-eyebrow">01 / 正在创作</p><h2 id="work-title">我的世界，从这里展开。</h2></div><Link href="/works">所有作品 ↗</Link></div>
      <article className="personal-work"><div className="personal-work-copy"><span className="personal-tag">世界观作品 · 持续更新</span><h3>帝国示录<span>我们是始嗣</span></h3><p>一个以「死亡帝国」为核心的世界。始嗣、人物、空间法则与异空间诸国，在这里一点点长出轮廓。</p><div className="personal-actions"><Link className="personal-primary" href="/works">查看作品页 ↗</Link><a className="personal-secondary" href="https://wuyeng4444.github.io/-/" target="_blank" rel="noopener noreferrer">进入设定集 →</a></div></div><img src="/gallery/cover.jpg" alt="《帝国示录》欢颂人物插画" width="700" height="500" /></article>
    </section>
